...
class OnboadingOneScreen extends GetWidget<OnboadingOneController> {
  @override
      ...
      child: Scaffold(
        body: SizedBox(
          ...
          child: Column(
            ...
            children: [
              CustomImageView(
                imagePath: ImageConstant.imgTeacherTeachingOrphan,
                height: 420.h,
                width: double.maxFinite,
              ),
      ...
      child: Column(
        children: [
          ...
          SizedBox(
            width: double.maxFinite,
            child: Text(
              "Join hands with NGOs to make a difference in your community".tr,
              maxLines: 3,
              overflow: TextOverflow.ellipsis,
              textAlign: TextAlign.center,

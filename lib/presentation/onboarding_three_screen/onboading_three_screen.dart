...
class OnboadingThreeScreen extends GetWidget<OnboadingThreeController> {
  @override
      ...
      child: Scaffold(
        body: SizedBox(
          ...
          child: Column(
            ...
            children: [
              CustomImageView(
                imagePath: ImageConstant.imgMakeAnImpact,
                height: 420.h,
                width: double.maxFinite,
              ),
      ...
      child: Column(
        children: [
          ...
          SizedBox(
            width: double.maxFinite,
            child: Text(
              "Your efforts can change lives and inspire others".tr,
              maxLines: 3,
              overflow: TextOverflow.ellipsis,
              textAlign: TextAlign.center,
